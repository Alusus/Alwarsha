  ...
  for (const GList *iter = copy; iter; iter = iter->next, i++)
    {
      ...
      path = g_strdup_printf ("/org/alusus/alwarsha/plugins/%s/",
                              peas_plugin_info_get_module_name (plugin_info));

      dzl_preferences_add_switch (preferences, "plugins", "plugins", "org.alusus.alwarsha.plugin", "enabled", path, NULL, name, desc, keywords, i);
    }
...
ide_preferences_builtin_register_appearance (DzlPreferences *preferences)
{
  ...
  dzl_preferences_add_spin_button (preferences, "appearance", "font", "org.alusus.alwarsha.editor", "line-spacing", NULL, _("Line Spacing"), _("Number of pixels above and below editor lines"), C_("Keywords", "editor line spacing font AlususMono"), 0);
...
ide_preferences_builtin_register_keyboard (DzlPreferences *preferences)
{
  ...
  dzl_preferences_add_radio (preferences, "keyboard", "mode", "org.alusus.alwarsha.editor", "keybindings", NULL, "\"default\"", _("Alwarsha"), _("Default keybinding mode which mimics gedit"), NULL, 0);

  dzl_preferences_add_list_group (preferences, "keyboard", "movements", _("Movement"), GTK_SELECTION_NONE, 100);
  dzl_preferences_add_switch (preferences, "keyboard", "movements", "org.alusus.alwarsha.editor", "smart-home-end", NULL, NULL, _("Smart Home and End"), _("Home moves to first non-whitespace character"), NULL, 0);
  dzl_preferences_add_switch (preferences, "keyboard", "movements", "org.alusus.alwarsha.editor", "smart-backspace", NULL, NULL, _("Smart Backspace"), _("Backspace will remove extra space to keep you aligned with your indentation"), NULL, 100);
}
...
ide_preferences_builtin_register_editor (DzlPreferences *preferences)
{
  ...
  dzl_preferences_add_switch (preferences, "editor", "line", "org.alusus.alwarsha.editor", "show-relative-line-numbers", NULL, NULL, _("Relative line numbers"), _("Show line numbers relative to the cursor line"), NULL, 0);
  dzl_preferences_add_switch (preferences, "editor", "line", "org.alusus.alwarsha.editor", "show-line-changes", NULL, NULL, _("Line changes"), _("Show if a line was added or modified next to line number"), NULL, 1);
  dzl_preferences_add_switch (preferences, "editor", "line", "org.alusus.alwarsha.editor", "show-line-diagnostics", NULL, NULL, _("Line diagnostics"), _("Show an icon next to line numbers indicating type of diagnostic"), NULL, 2);

  dzl_preferences_add_list_group (preferences, "editor", "highlight", _("Highlight"), GTK_SELECTION_NONE, 100);
  dzl_preferences_add_switch (preferences, "editor", "highlight", "org.alusus.alwarsha.editor", "highlight-current-line", NULL, NULL, _("Current line"), _("Make current line stand out with highlights"), NULL, 0);
  dzl_preferences_add_switch (preferences, "editor", "highlight", "org.alusus.alwarsha.editor", "highlight-matching-brackets", NULL, NULL, _("Matching brackets"), _("Highlight matching brackets based on cursor position"), NULL, 1);

  dzl_preferences_add_list_group (preferences, "editor", "overview", _("Code Overview"), GTK_SELECTION_NONE, 100);
  dzl_preferences_add_switch (preferences, "editor", "overview", "org.alusus.alwarsha.editor", "show-map", NULL, NULL, _("Show overview map"), _("A zoomed out view to enhance navigating source code"), NULL, 0);
  dzl_preferences_add_switch (preferences, "editor", "overview", "org.alusus.alwarsha.editor", "auto-hide-map", NULL, NULL, _("Automatically hide overview map"), _("Automatically hide map when editor loses focus"), NULL, 1);

  dzl_preferences_add_list_group (preferences, "editor", "draw-spaces", _("Visible Whitespace Characters"), GTK_SELECTION_NONE, 400);
  dzl_preferences_add_radio (preferences, "editor", "draw-spaces", "org.alusus.alwarsha.editor", "draw-spaces", NULL, "\"space\"", _("Spaces"), NULL, NULL, 0);
  dzl_preferences_add_radio (preferences, "editor", "draw-spaces", "org.alusus.alwarsha.editor", "draw-spaces", NULL, "\"tab\"", _("Tabs"), NULL, NULL, 1);
  dzl_preferences_add_radio (preferences, "editor", "draw-spaces", "org.alusus.alwarsha.editor", "draw-spaces", NULL, "\"newline\"", _("New line and carriage return"), NULL, NULL, 2);
  dzl_preferences_add_radio (preferences, "editor", "draw-spaces", "org.alusus.alwarsha.editor", "draw-spaces", NULL, "\"nbsp\"", _("Non-breaking spaces"), NULL, NULL, 3);
  dzl_preferences_add_radio (preferences, "editor", "draw-spaces", "org.alusus.alwarsha.editor", "draw-spaces", NULL, "\"text\"", _("Spaces inside of text"), NULL, NULL, 4);
  dzl_preferences_add_radio (preferences, "editor", "draw-spaces", "org.alusus.alwarsha.editor", "draw-spaces", NULL, "\"trailing\"", _("Trailing Only"), NULL, NULL, 5);
  dzl_preferences_add_radio (preferences, "editor", "draw-spaces", "org.alusus.alwarsha.editor", "draw-spaces", NULL, "\"leading\"", _("Leading Only"), NULL, NULL, 6);

  dzl_preferences_add_list_group (preferences, "editor", "autosave", _("Autosave"), GTK_SELECTION_NONE, 450);
  dzl_preferences_add_switch (preferences, "editor", "autosave", "org.alusus.alwarsha.editor", "auto-save", NULL, NULL,_("Autosave Enabled"), _("Enable or disable autosave feature"), NULL, 1);
  dzl_preferences_add_spin_button (preferences, "editor", "autosave", "org.alusus.alwarsha.editor", "auto-save-timeout", NULL, _("Autosave Frequency"), _("The number of seconds after modification before auto saving"), NULL, 60);
}
...
ide_preferences_builtin_register_code_insight (DzlPreferences *preferences)
{
  ...
  dzl_preferences_add_switch (preferences, "code-insight", "highlighting", "org.alusus.alwarsha.code-insight", "semantic-highlighting", NULL, NULL, _("Semantic Highlighting"), _("Use code insight to highlight additional information discovered in source file"), NULL, 0);
...
ide_preferences_builtin_register_completion (DzlPreferences *preferences)
{
  ...
  dzl_preferences_add_spin_button (preferences, "completion", "general", "org.alusus.alwarsha.editor", "completion-n-rows", NULL, _("Completions Display Size"), _("Number of completions to display"), NULL, -1);
  dzl_preferences_add_switch (preferences, "completion", "general", "org.alusus.alwarsha.editor", "interactive-completion", NULL, NULL, _("Interactive Completion"), _("Display code suggestions interactively as you type"), NULL, 0);
...
ide_preferences_builtin_register_languages (DzlPreferences *preferences)
{
  ...
  dzl_preferences_add_switch (preferences, "languages.id", "basic", "org.alusus.alwarsha.editor.language", "trim-trailing-whitespace", "/org/alusus/alwarsha/editor/language/{id}/", NULL, _("Trim trailing whitespace"), _("Upon saving, trailing whitespace from modified lines will be trimmed."), NULL, 10);
  dzl_preferences_add_switch (preferences, "languages.id", "basic", "org.alusus.alwarsha.editor.language", "overwrite-braces", "/org/alusus/alwarsha/editor/language/{id}/", NULL, _("Overwrite Braces"), _("Overwrite closing braces"), NULL, 20);
  dzl_preferences_add_switch (preferences, "languages.id", "basic", "org.alusus.alwarsha.editor.language", "insert-matching-brace", "/org/alusus/alwarsha/editor/language/{id}/", NULL, _("Insert Matching Brace"), _("Insert matching character for { [ ( or \""), NULL, 20);
  dzl_preferences_add_switch (preferences, "languages.id", "basic", "org.alusus.alwarsha.editor.language", "insert-trailing-newline", "/org/alusus/alwarsha/editor/language/{id}/", NULL, _("Insert Trailing Newline"), _("Ensure files end with a newline"), NULL, 30);

  dzl_preferences_add_list_group (preferences, "languages.id", "margin", _("Margins"), GTK_SELECTION_NONE, 0);
  dzl_preferences_add_radio (preferences, "languages.id", "margin", "org.alusus.alwarsha.editor.language", "show-right-margin", "/org/alusus/alwarsha/editor/language/{id}/", NULL, _("Show right margin"), NULL, NULL, 0);
  dzl_preferences_add_spin_button (preferences, "languages.id", "margin", "org.alusus.alwarsha.editor.language", "right-margin-position", "/org/alusus/alwarsha/editor/language/{id}/", _("Right margin position"), _("Position in spaces for the right margin"), NULL, 10);

  dzl_preferences_add_list_group (preferences, "languages.id", "indentation", _("Indentation"), GTK_SELECTION_NONE, 100);
  dzl_preferences_add_spin_button (preferences, "languages.id", "indentation", "org.alusus.alwarsha.editor.language", "tab-width", "/org/alusus/alwarsha/editor/language/{id}/", _("Tab width"), _("Width of a tab character in spaces"), NULL, 10);
  dzl_preferences_add_radio (preferences, "languages.id", "indentation", "org.alusus.alwarsha.editor.language", "insert-spaces-instead-of-tabs", "/org/alusus/alwarsha/editor/language/{id}/", NULL, _("Insert spaces instead of tabs"), _("Prefer spaces over use of tabs"), NULL, 20);
  dzl_preferences_add_radio (preferences, "languages.id", "indentation", "org.alusus.alwarsha.editor.language", "auto-indent", "/org/alusus/alwarsha/editor/language/{id}/", NULL, _("Automatically indent"), _("Indent source code as you type"), NULL, 30);

  dzl_preferences_add_list_group (preferences, "languages.id", "spaces-style", _("Spacing"), GTK_SELECTION_NONE, 600);
  dzl_preferences_add_radio (preferences, "languages.id", "spaces-style", "org.alusus.alwarsha.editor.language", "spaces-style", "/org/alusus/alwarsha/editor/language/{id}/", "\"before-left-paren\"", _("Space before opening parentheses"), NULL, NULL, 0);
  dzl_preferences_add_radio (preferences, "languages.id", "spaces-style", "org.alusus.alwarsha.editor.language", "spaces-style", "/org/alusus/alwarsha/editor/language/{id}/", "\"before-left-bracket\"", _("Space before opening brackets"), NULL, NULL, 1);
  dzl_preferences_add_radio (preferences, "languages.id", "spaces-style", "org.alusus.alwarsha.editor.language", "spaces-style", "/org/alusus/alwarsha/editor/language/{id}/", "\"before-left-brace\"", _("Space before opening braces"), NULL, NULL, 2);
  dzl_preferences_add_radio (preferences, "languages.id", "spaces-style", "org.alusus.alwarsha.editor.language", "spaces-style", "/org/alusus/alwarsha/editor/language/{id}/", "\"before-left-angle\"", _("Space before opening angles"), NULL, NULL, 3);
  dzl_preferences_add_radio (preferences, "languages.id", "spaces-style", "org.alusus.alwarsha.editor.language", "spaces-style", "/org/alusus/alwarsha/editor/language/{id}/", "\"colon\"", _("Prefer a space before colons"), NULL, NULL, 4);
  dzl_preferences_add_radio (preferences, "languages.id", "spaces-style", "org.alusus.alwarsha.editor.language", "spaces-style", "/org/alusus/alwarsha/editor/language/{id}/", "\"comma\"", _("Prefer a space before commas"), NULL, NULL, 5);
  dzl_preferences_add_radio (preferences, "languages.id", "spaces-style", "org.alusus.alwarsha.editor.language", "spaces-style", "/org/alusus/alwarsha/editor/language/{id}/", "\"semicolon\"", _("Prefer a space before semicolons"), NULL, NULL, 6);
}
...
ide_preferences_builtin_register_build (DzlPreferences *preferences)
{
  ...
  id = dzl_preferences_add_spin_button (preferences, "build", "basic", "org.alusus.alwarsha.build", "parallel", "/org/alusus/alwarsha/build/", _("Build Workers"), _("Number of parallel build workers"), NULL, 0);
...
ide_preferences_builtin_register_projects (DzlPreferences *preferences)
{
  ...
  dzl_preferences_add_file_chooser (preferences, "projects", "directory", "org.alusus.alwarsha", "projects-directory", NULL, _("Projects directory"), _("A place for all your projects"), GTK_FILE_CHOOSER_ACTION_SELECT_FOLDER, NULL, 0);
  dzl_preferences_add_switch (preferences, "projects", "directory", "org.alusus.alwarsha", "restore-previous-files", NULL, NULL, _("Restore previously opened files"), _("Open previously opened files when loading a project"), NULL, 10);
}
