                                  ...
                                  DzlPreferences      *preferences)
{
  ...
  self->diagnose_id = dzl_preferences_add_switch (preferences,
                                                  ...
                                                  "enabled",
                                                  "/org/alusus/alwarsha/extension-types/clang-plugin/IdeDiagnosticProvider/",
                                                  NULL,
                                                  _("Clang"),
  ...
  self->completion_id = dzl_preferences_add_switch (preferences,
                                                    ...
                                                    "org.alusus.alwarsha.extension-type",
                                                    "enabled",
                                                    "/org/alusus/alwarsha/extension-types/clang-plugin/IdeCompletionProvider/",
                                                    NULL,
